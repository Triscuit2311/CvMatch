...
namespace CvWindowScanner.Utils
{
    public static class InputWrapper
    {
        ...
        public static void QuickPress( VK key)
        {
            Input[] inputs = {
                new Input
                {
        ...
        public static void PressKeyFor( VK key, int time)
        {
            Input[] inputs = {
                new Input
                {
            ...
            Input[] inputs = new Input[]
            {
                new Input
                {
                    ...
                    u = new InputUnion
                    {
                        mi = new MouseInput
                        {
                            dwFlags = (uint)(rightClick? MouseEventF.RightDown : MouseEventF.LeftDown),
                            dwExtraInfo = GetMessageExtraInfo()
                        }
                    }
                },
                new Input
                {
                    ...
                    u = new InputUnion
                    {
                        mi = new MouseInput
                        {
                            dwFlags = (uint)(rightClick? MouseEventF.RightUp : MouseEventF.LeftUp),
                            dwExtraInfo = GetMessageExtraInfo()
                        }
                    }
                }
